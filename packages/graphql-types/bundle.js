...
var Category = gql(_templateObject$2);

var Merchant = gql(_templateObject2$2);

var TransactionType = gql(_templateObject3);

var Message = gql(_templateObject4);

var Transaction = gql(_templateObject5);

var Transaction$1 = (function () {
  return [Date$1, Transaction, TransactionType, Merchant, Message, Category];
});
...
var RootQuery = gql(_templateObject);

var Schema = gql(_templateObject2);
